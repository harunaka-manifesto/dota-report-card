...
Two independent investigations produced capability matrices on 2026-09-20. They agree on every material point; where their granularity differs, the more conservative reading is used here. Full matrices: [`evidence/post-match-ingestion-probe-2026-09-20.md`](evidence/post-match-ingestion-probe-2026-09-20.md) §5 and [`../../docs/evidence/provider-post-match-architecture-investigation-2026-09-20.md`](../../docs/evidence/provider-post-match-architecture-investigation-2026-09-20.md) §5.

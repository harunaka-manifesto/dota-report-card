...
const presentationCopy = (key, qualified) => {
  ...
  return {
    ...
    fallback: { title: "More evidence needed", body: "The pattern remains visible, but no narrower action cleared the evidence gate." }
  };
};
const presentationProof = (key) => ({
  same_playbook: { hero_names: ["Anti-Mage", "Axe", "Rubick"], regular_hero_count: 3, strongest_jobs: ["Teamfight", "Initiation"], job_clusters: [{ job: "Teamfight", hero_names: ["Axe", "Rubick"], hero_count: 2 }, { job: "Initiation", hero_names: ["Axe"], hero_count: 1 }] },
  ...
  versatile_core: { hero_job_maps: [{ hero_name: "Axe", primary_jobs: ["Initiation", "Frontline"] }, { hero_name: "Rubick", primary_jobs: ["Teamfight", "Save"] }], coverage: { strongly_covered: ["Teamfight"], thin: ["Wave clear"], missing: ["Global presence"] } },
  proven_flexibility: { window_label: "2026-01-01 – 2026-01-07", hero_names: ["Anti-Mage", "Axe", "Rubick"], hero_rows: [{ hero_name: "Anti-Mage", game_count: 5 }, { hero_name: "Axe", game_count: 3 }, { hero_name: "Rubick", game_count: 2 }], total_games: 10, functional_jobs: ["Initiation", "Teamfight", "Save"], functional_job_count: 3, repeated_hero_count: 2 },

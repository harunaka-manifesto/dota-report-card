...
``report_card.player_analysis_v7.research.tables`` semantics. Nothing here issues a provider call,
...
from report_card.player_analysis_v7.research.corpus import DISCOVERY, CorpusPaths, iter_players

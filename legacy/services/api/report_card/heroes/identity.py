...
from report_card.heroes.taxonomy import HeroTaxonomy, HeroTaxonomyEntry, load_default_taxonomy
...
def select_hero_identity(
    ...
    try:
        from report_card.heroes.patterns import extract_hero_patterns

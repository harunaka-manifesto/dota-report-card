...
from report_card.analysis.deep_scan import (
    acquire_selected_matches,
    evaluate_deep_hypotheses,
    plan_deep_scan,
    plan_diagnostic_deep_scan,
)
from report_card.analysis.source import OpenDotaAnalysisSource
from report_card.api.report_schemas import validate_free_dna_report
from report_card.cohorts.selector import CohortSelection, select_narrowest_cohort
from report_card.dna.pipeline import analyze_dna
from report_card.dna.sessions import SessionPolicy, infer_sessions
from report_card.features.calculators import calculate_match_features
...
from report_card.features.summary_models import SummaryFeatureSet
from report_card.ingestion.coverage import coverage_for_match
from report_card.ingestion.eligibility import assess_match
from report_card.ingestion.normalize import NormalizedMatch
...
from report_card.player_analysis_v6.calibration import load_threshold_artifact
...
from report_card.player_analysis_v61.versions import MODEL_VERSION as V61_MODEL_VERSION
from report_card.reports.assembly import assemble_player_dna_report, assemble_report
from report_card.reports.dna_assembly import assemble_legacy_free_dna_report
from report_card.reports.dna_assembly_v6 import assemble_free_dna_report_v6
from report_card.reports.dna_assembly_v61 import assemble_free_dna_report_v61
from report_card.storage.repository import AnalysisJob, InMemoryRepository
...
class AnalysisService:
    ...
    def _compatibility_model_version(self, analysis_mode: str) -> str:
        if analysis_mode == "free":
            if self.settings.free_dna_v61_enabled:
                from report_card.player_analysis_v61.versions import default_versions_v61
            ...
            if self.settings.free_dna_v6_enabled:
                from report_card.player_analysis_v6.models import default_versions
            ...
            from report_card.behavior.context_baseline import CONTEXT_BASELINE_VERSION
            from report_card.behavior.elements.registry import ELEMENT_REGISTRY_VERSION
            from report_card.behavior.outcomes import SEMANTIC_OUTCOME_VERSION
            from report_card.behavior.patterns.registry import PATTERN_REGISTRY_VERSION
            from report_card.behavior.service import BEHAVIOR_MODEL_VERSION
            from report_card.content.catalog import copy_version, semantic_copy_version
            from report_card.dna.features.models import FEATURE_VERSION
            from report_card.dna.performance import PERFORMANCE_PROXY_VERSION
            from report_card.dna.pipeline import DNA_SCORING_VERSION
            from report_card.dna.recency import RECENCY_WEIGHTING_VERSION
            from report_card.dna.sessions import SESSION_VERSION
            from report_card.hero_portfolio.config import PORTFOLIO_CONFIG_VERSION
            from report_card.hero_portfolio.version import (
            ...
            from report_card.heroes.recommendations import SEMANTIC_RECOMMENDATION_VERSION
            from report_card.heroes.taxonomy import TAXONOMY_VERSION
            from report_card.reports.dna_assembly import REPORT_SCHEMA_VERSION, REPORT_STORY_VERSION
            from report_card.share.service import RENDERER_VERSION
    ...
    def _enqueue(self, job: AnalysisJob, identifier: PlayerIdentifier) -> None:
        ...
        if self.settings.effective_analysis_execution_backend == "celery":
            try:
                from report_card.workers.tasks import celery_app

...
from report_card.hypotheses.generator import generate_diagnostic_hypotheses, generate_hypotheses
from report_card.hypotheses.models import DiagnosticQuestion, Hypothesis
from report_card.ingestion.coverage import coverage_for_match
from report_card.ingestion.eligibility import assess_match
from report_card.ingestion.normalize import NormalizedMatch, normalize_match
from report_card.patterns.models import PatternCandidate
from report_card.selection.candidates import generate_candidate_matches
from report_card.selection.models import SelectionPlan
from report_card.selection.planner import plan_selection

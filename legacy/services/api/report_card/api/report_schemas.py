...
from report_card.api.report_schemas_v6 import FreeDnaReportV6Schema, validate_free_dna_report_v6
from report_card.api.report_schemas_v61 import FreeDnaReportV61Schema, validate_free_dna_report_v61
...
class FreeDnaReportV4Schema(PublicModel):
    ...
    def validate_v5_contract(self) -> FreeDnaReportV4Schema:
        ...
        from report_card.content.catalog import semantic_copy_version

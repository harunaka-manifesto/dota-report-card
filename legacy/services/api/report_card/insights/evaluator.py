...
from report_card.cohorts.selector import CohortSelection
from report_card.cohorts.statistics import normal_interval, wilson_interval
from report_card.features.models import MatchFeature
from report_card.insights.gates import GateResult, apply_publication_gates
from report_card.insights.models import EvidenceObject, MetricObservation
from report_card.insights.ranking import rank_evidence
from report_card.insights.registry import INSIGHT_DEFINITIONS, InsightDefinition
...
class InsightContext:
    ...
    history_limit: int | None = FREE_HISTORY_LIMIT

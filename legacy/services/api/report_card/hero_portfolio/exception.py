...
from report_card.content.renderer import resolve_portfolio_copy
from report_card.hero_portfolio.config import PORTFOLIO_CONFIG
from report_card.hero_portfolio.eligibility import build_hero_eligibility, eligible_heroes
from report_card.hero_portfolio.models import ChoiceOption, HeroEligibility, HeroExceptionResult
from report_card.hero_portfolio.ordering import stable_pseudo_shuffle
from report_card.heroes.knowledge import FUNCTIONAL_JOBS, HeroKnowledgeProvider
from report_card.heroes.taxonomy import TRAITS, HeroTaxonomy

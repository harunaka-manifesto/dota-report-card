...
from report_card.hero_portfolio.models import PoolEvolutionResult
from report_card.heroes.knowledge import HeroKnowledgeProvider, canonical_function_key

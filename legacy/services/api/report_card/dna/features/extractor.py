...
from report_card.dna.performance import PERFORMANCE_PROXY_VERSION, build_performance_map
...
def extract_dna_features(
    ...
    *,
    ...
    from report_card.dna.dimensions.service import score_dimensions

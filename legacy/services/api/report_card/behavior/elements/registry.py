...
from report_card.behavior.models import ElementDefinition
from report_card.behavior.tiers import SUMMARY_CAPABILITIES

ELEMENT_REGISTRY_VERSION = "free-elements-5.2.0"

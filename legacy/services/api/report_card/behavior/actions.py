...
from report_card.behavior.context_baseline import (
    CONTEXT_BASELINE_VERSION,
    primary_function,
    resolve_leave_group_out_baseline,
)
from report_card.behavior.display_bands import job_display_label
...
from report_card.dna.breakpoints import SESSION_BUCKETS, detect_breakpoint
from report_card.dna.performance import activity_rate, build_performance_map, death_rate
from report_card.dna.recency import (
    effective_sample_size,
    recency_weight,
    weighted_mean,
    weighted_median,
)
from report_card.dna.sessions import SessionResult
...
from report_card.heroes.evidence import (
...
from report_card.heroes.recommendations import (
    HeroRecommendationRationale,
    recommend_semantic_heroes,
)
from report_card.heroes.relationships import (
    build_pool_profile,

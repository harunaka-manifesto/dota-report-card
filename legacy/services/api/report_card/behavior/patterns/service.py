...
from report_card.behavior.comparisons import clamp, confidence_label
...
from report_card.behavior.models import ElementResult, PatternDefinition, PatternResult
